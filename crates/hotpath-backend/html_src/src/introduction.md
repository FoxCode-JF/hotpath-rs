...
<div class="waitlist-card">
  ...
  <p>See exactly what changed between commits and where to look next.</p>
  <div class="waitlist-cta-row">
    ...
    <p class="waitlist-cta-note">We'll only email you when early access becomes available.</p>
    <p class="waitlist-social-note">Or follow <a href="https://x.com/_pawurb" target="_blank" rel="noopener">@_pawurb</a> on X for development updates.</p>
  </div>
</div>
